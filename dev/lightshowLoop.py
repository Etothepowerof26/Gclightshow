...
light3=light.Light(pinList[2],"8")
light4=light.Light(pinList[3],"7")
light5=light.Light(pinList[4],"6")
light6=light.Light(pinList[5],"5")
light7=light.Light(pinList[6],"4")
light8=light.Light(pinList[7],"3")
